import { ONE_WEEK, ONE_YEAR, type boolstring } from "@mia-cx/utils/constants";
import {
	delete_cookie,
	get_cookies,
	set_cookie,
...
const cookie_consent_store: MapStore<CookieConsent> =
	persistentMap<CookieConsent>("cookie-consent:", default_consent);
