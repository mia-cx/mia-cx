export const FIELD_PARAMETER_SCHEMA = [
    ...
    { key: 'secondaryBlendMode', label: 'Cloud blend mode', min: 0, max: 2, step: 1, default: 0 },
    { key: 'secondaryRibbonBlendMode', label: 'Ribbon blend mode', min: 0, max: 2, step: 1, default: 0 },
