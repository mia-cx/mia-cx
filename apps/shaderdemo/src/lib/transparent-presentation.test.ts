...
describe('transparent shader presentation', () => {
    ...
    it('mirrors the canvas through non-fixed video only in iOS Safari', () => {
        ...
        expect(page).toContain('canvas.captureStream?.(30)');
        expect(page).toContain('ios-safari-canvas-mirror');
